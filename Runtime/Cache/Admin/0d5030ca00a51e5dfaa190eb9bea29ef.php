...
<div class="admin-content">
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">常用模块</strong> / <small>用户管理</small></div>
  </div>
  <div class="am-g">
    <div class="am-u-sm-12 am-u-md-6">
      <div class="am-btn-toolbar">
        <div class="am-btn-group am-btn-group-xs">
          <button type="button" class="am-btn am-btn-default" onClick="location.href='/Admin/User/../user/add'"><span class="am-icon-plus"></span> 新增</button>
        ...
        <table class="am-table am-table-striped am-table-hover table-main">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if(($vo["status"]) != "0"): ?>class="am-disabled"<?php endif; ?>>
            ...
            <td><div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                  <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="location.href='/Admin/User/../user/edit?uid=<?php echo ($vo["uid"]); ?>'"><span class="am-icon-pencil-square-o"></span> 编辑</button>
                  <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="if(confirm('确定删除吗？')) location.href='/Admin/User/../user/del?uid=<?php echo ($vo["uid"]); ?>'"><span class="am-icon-trash-o"></span> 删除</button>
                  <button type="button" class="am-btn am-btn-default" onclick="location.href='/Admin/User/../user/status?uid=<?php echo ($vo["uid"]); ?>&status=<?php echo ($vo["status"]); ?>'"><span class=""></span> <?php if(($vo["status"]) == "0"): ?>正常<?php else: ?>已停用<?php endif; ?></button>
                </div>
              </div></td>
