...
<div class="am-cf admin-main">
      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="/Admin/Cate/../user/all" class="am-cf"><span class="am-icon-check"></span>用户管理<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li><a href="/Admin/Cate/../cate/all"><span class="am-icon-puzzle-piece"></span> 类别管理</a></li>
            <li><a href="/Admin/Cate/../item/all"><span class="am-icon-th"></span> 商品管理</a></li>
        ...
        <li><a href="/Admin/Cate/../user/logout"><span class="am-icon-sign-out"></span> 注销</a></li>
      </ul>
  ...
  <div class="admin-content">
	...
	<form class="am-form" method="post" action="/Admin/Cate/../cate/batch">
    <div class="am-g">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
          ...
          <tbody>
              ...
              <td><input name="id[]" type="checkbox" id="id[]" value="<?php echo ($vo["id"]); ?>" /></td>
              <td><?php echo ($vo["id"]); ?></td>
              <td>
              <input name="hid[]" type="hidden" value="<?php echo ($vo["id"]); ?>" />
              <input name="name[]" type="text" value="<?php echo ($vo["name"]); ?>" /></td>
              <td class="am-hide-sm-only"><?php if(!empty($vo["pic"])): ?><img src="/Public/img/<?php echo ($vo["pic"]); ?>"/><?php endif; ?></td>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="del('/Admin/Cate/del?id=<?php echo ($vo["id"]); ?>')"><span class="am-icon-trash-o"></span> 删除</button>             
                    <button type="button" class="am-btn am-btn-default" onclick="location.href='/Admin/Cate/../cate/status?id=<?php echo ($vo["id"]); ?>&status=<?php echo ($vo["status"]); ?>'"><span class=""></span> <?php if(($vo["status"]) == "0"): ?>正常<?php else: ?>已停用<?php endif; ?></button>
                  </div>
                </div>
              </td>
            </tr>
            <?php if(is_array($vo["subCate"])): $i = 0; $__LIST__ = $vo["subCate"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subvo): $mod = ($i % 2 );++$i;?><tr <?php if(($subvo["status"]) != "0"): ?>class="am-disabled"<?php endif; ?>>
              <td><input name="id[]" type="checkbox" id="id[]" value="<?php echo ($subvo["id"]); ?>" /></td>
              <td><?php echo ($subvo["id"]); ?></td>
              <td style="padding-left:30px">
              <input name="hid[]" type="hidden" value="<?php echo ($subvo["id"]); ?>" />
              <input type="text" name="name[]" value="<?php echo ($subvo["name"]); ?>" /></a></td>
              <td class="am-hide-sm-only"></td>
              <td class="am-hide-sm-only"></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    ...
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="del('/Admin/Cate/del?id=<?php echo ($subvo["id"]); ?>')"><span class="am-icon-trash-o"></span> 删除</button>             
                    <button type="button" class="am-btn am-btn-default" onclick="location.href='/Admin/Cate/../cate/status?id=<?php echo ($subvo["id"]); ?>&status=<?php echo ($subvo["status"]); ?>'"><span class=""></span> <?php if(($subvo["status"]) == "0"): ?>正常<?php else: ?>已停用<?php endif; ?></button>
                  </div>
                </div>
              </td>
        ...
        <div class="am-cf">
		  共<?php echo ($count); ?>个一级类别，<?php echo ($subCount); ?>个二级类别
		  <div class="am-fr">
